                                    ...
                                    <td className='py-2 px-4'>
                                        {editElm?._id ?
                                            <span
                                                ...
                                                className='px-2 text-orange-300 hover:underline cursor-pointer'>Back</span>
                                            : <span
                                                onClick={() => setEditElm(el)}
                                                className='px-2 text-orange-300 hover:underline cursor-pointer'>edit</span>}
                                        <span
                                            onClick={() => handleDeleteUser(el._id)}
                                            className='px-2 text-orange-300 hover:underline cursor-pointer'>delete</span>
                                    </td>
                                </tr>
                            ))}
                        </tbody>
